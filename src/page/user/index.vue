    ...
    <div>
        <div class="user-profile">
            ...
            <div class="user-profile-username">
                <a href="/#/user/info/userInfo">
                    <span class="m-nick">{{data.customerName}}</span>
                </a>
                <p class="font12">{{data.companyName}}{{data.customerLevel}}</p>
            </div>
        </div>
        ...
        <div style="padding: 10px">
            <van-button size="large" plain hairline type="danger" @click="logout()">退出账号</van-button>
        </div>
        <navigate :active="4"/>
    </div>
</template>
...
<script>
    import {applogout} from "../../api/account";
    import {GetUserIndex} from "../../api/my";
    import {cleanAccount} from "../../config/common.js";
