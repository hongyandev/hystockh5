    ...
    <div class="product-list">
        ...
        <div class="filterbar">
            <ul :class="filtersort?'show':''">
                <li :class="filterindex==0?'selected':''" v-on:click="onFilterBar(0)"><span>{{filterindex==11?'价格最低':(filterindex==12?'价格最高':'综合')}}</span>
            ...
            <van-popup v-model="filtershow" position="right" class="filterlayer">
                <div class="filterInner" style="overflow-y: scroll;max-height: 100%;">
                    ...
                    <div style="clear: both;"></div>
                    <van-button size="large" style="height: 40px;margin-bottom: 15px;line-height: 40px;">清除选项
                    </van-button>
